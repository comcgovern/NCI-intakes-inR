...
.GH_TABLES <- list(
  ...
  `5` = list(
    nodes   = c(-2.020182870456, -0.9585724646138, 0.0,
                 0.9585724646138, 2.020182870456),
    weights = c(0.01995324205905, 0.3936193231522, 0.9453087204829,
                0.3936193231522, 0.01995324205905)
  ),
  `7` = list(
  ...
  `9` = list(
    nodes   = c(-3.190993201782, -2.266580584532, -1.468553289217,
                -0.7235510187528, 0.0, 0.7235510187528, 1.468553289217,
                 2.266580584532, 3.190993201782),
    weights = c(3.960697726326e-05, 0.004943624275537, 0.08847452739438,
                0.4326515590026, 0.7202352156061, 0.4326515590026,
                0.08847452739438, 0.004943624275537, 3.960697726326e-05)
  )
)
...
gh_nodes_adaptive <- function(n, eta_i, mu_i, consumed_i, t_y_i,
  ...
  # Precision matrix of the bivariate normal prior BVN(0, Sigma)
  sigma_mat <- matrix(
